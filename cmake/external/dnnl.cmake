...
set(MY_DNNL_SRC_DIR /home/jywang/oneDNN)
if(WIN32)
...
if (onnxruntime_USE_DNNL)
  ...
  ExternalProject_Add(project_dnnl
    ...
    UPDATE_COMMAND rsync -a ${MY_DNNL_SRC_DIR}/ ${DNNL_SOURCE}/
    # BINARY_DIR ${DNNL_SOURCE}/build
    # DOWNLOAD_COMMAND "ln -s ${MY_DNNL_SRC_DIR} ${DNNL_SOURCE}"
    # GIT_REPOSITORY ${DNNL_URL}
    # GIT_TAG ${DNNL_TAG}
    # PATCH_COMMAND ${MKLDNN_PATCH_DISCARD_COMMAND} COMMAND ${DNNL_PATCH_COMMAND}
    CMAKE_ARGS -DDNNL_BUILD_TESTS=OFF -DDNNL_BUILD_EXAMPLES=OFF -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DCMAKE_INSTALL_PREFIX=${DNNL_INSTALL} -DDNNL_CPU_RUNTIME=SEQ ${DNNL_GPU_CMAKE_ARGS}
  )
